...
namespace FullStackIntro.Models
{
    ...
    {
        //the job of the DAL is to talk to our datavase and give data over to our controller
        ...
        public Movie GetMovie(int id)
        {
            ...
            {
                match = new Movie();
                match.Title = $"Movie at index {id} was not found, please try another input";
            }
            return match;
        }
